    ...
    <div className="add-library">
      ...
      >
        <div className="add-library__section">
          <h2 className="add-library__section-title">
            {t("addLibrary.userInfo")}
          </h2>
          <div className="add-library__grid">
            <Form.Item
              ...
              rules={[
                { required: true, message: t("addLibrary.nameRequired") },
              ]}
            >
            ...
            <Form.Item
              ...
              rules={[
                { required: true, message: t("addLibrary.phoneRequired") },
              ]}
            >
            ...
            <Form.Item
              ...
              rules={[
                { required: true, message: t("addLibrary.passwordRequired") },
              ]}
            >
              <Input.Password
                placeholder={t("addLibrary.passwordPlaceholder")}
              />
            </Form.Item>
          </div>
        </div>
        ...
        <div className="add-library__section">
          ...
          <div className="add-library__grid">
            <Form.Item
              ...
              rules={[
                { required: true, message: t("addLibrary.addressRequired") },
              ]}
            >
              <AutoComplete
                ...
                notFoundContent={
                  searchLoading
                    ? t("addLibrary.searching")
                    : t("addLibrary.noResults")
                }
                style={{ width: "100%" }}
              />
            </Form.Item>
            ...
            <Form.Item
              ...
              rules={[
                { required: true, message: t("addLibrary.latitudeRequired") },
              ]}
            >
              <Input
                placeholder={t("addLibrary.latitudePlaceholder")}
                readOnly
              />
            </Form.Item>
            ...
            <Form.Item
              ...
              rules={[
                { required: true, message: t("addLibrary.longitudeRequired") },
              ]}
            >
              <Input
                placeholder={t("addLibrary.longitudePlaceholder")}
                readOnly
              />
            </Form.Item>
          </div>
